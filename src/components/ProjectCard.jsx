...
const ProjectCard = ({ project }) => {
  return (
    ...
    >
      ...
      <div className="bg-card backdrop-blur-xl rounded-3xl overflow-hidden border border-main group-hover:border-primary/20 transition-all duration-500 h-full flex flex-col shadow-sm">
        ...
        <div className="p-10 flex-1 flex flex-col justify-between">
          <div className="space-y-4">
            <div className="flex items-center gap-2 group/title">
              ...
              <a href={project.demo} target="_blank" rel="noopener noreferrer" className="hover:text-primary transition-colors duration-300">
                <h3 className="text-3xl font-black text-main tracking-tighter group-hover/title:text-primary transition-colors">{project.title}</h3>
              </a>
            </div>
          ...
          <div className="pt-8 flex flex-col gap-6">
            ...
            {project.github && (
              <a 
                ...
                className="inline-flex items-center gap-2 text-[10px] font-black uppercase tracking-[0.2em] text-primary hover:text-white transition-all group/repo w-fit"
              >
                <span className="material-symbols-outlined text-sm group-hover/repo:rotate-12 transition-transform">terminal</span>
                Mira la repo aquí
                <span className="w-0 h-[1px] bg-white group-hover:w-full transition-all duration-500" />
              </a>
            )}
          </div>
        </div>
